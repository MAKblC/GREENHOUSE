...
function doPost(e) {
  var ss = SpreadsheetApp.openById("1GXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXFtoE3E");
...
function doGet(e) {
  ...
  if (read !== undefined) {
    ...
    return ContentService.createTextOutput(SpreadsheetApp.openById('1GXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXFtoE3E').getSheetByName('ESP_sensor').getRange(4, 2, 1, 6).getValues());
    // считать ячейку C2
